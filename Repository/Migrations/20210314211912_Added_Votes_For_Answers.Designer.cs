...
namespace Repository.Migrations
{
    ...
    [Migration("20210314211912_Added_Votes_For_Answers")]
    partial class Added_Votes_For_Answers
    {
            ...
            modelBuilder.Entity("Repository.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2021, 3, 14, 18, 19, 11, 452, DateTimeKind.Local).AddTicks(1809),
                            LastUpdated = new DateTime(2021, 3, 14, 18, 19, 11, 454, DateTimeKind.Local).AddTicks(4843),
                            Name = "Vida"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2021, 3, 14, 18, 19, 11, 454, DateTimeKind.Local).AddTicks(6534),
                            LastUpdated = new DateTime(2021, 3, 14, 18, 19, 11, 454, DateTimeKind.Local).AddTicks(6548),
                            Name = "Juegos"
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2021, 3, 14, 18, 19, 11, 454, DateTimeKind.Local).AddTicks(6552),
                            LastUpdated = new DateTime(2021, 3, 14, 18, 19, 11, 454, DateTimeKind.Local).AddTicks(6554),
                            Name = "Amor"
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2021, 3, 14, 18, 19, 11, 454, DateTimeKind.Local).AddTicks(6557),
                            LastUpdated = new DateTime(2021, 3, 14, 18, 19, 11, 454, DateTimeKind.Local).AddTicks(6559),
                            Name = "Dolores"
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2021, 3, 14, 18, 19, 11, 454, DateTimeKind.Local).AddTicks(6562),
                            LastUpdated = new DateTime(2021, 3, 14, 18, 19, 11, 454, DateTimeKind.Local).AddTicks(6565),
                            Name = "Miselaneo"
                        });
                });
